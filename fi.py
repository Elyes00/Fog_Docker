...
def mail():
    smtpUser = 'elyes.benamor@etudiant-enit.utm.tn'
    smtpPass = 'Pewdipie123.'
    toAdd = 'elyes.benamor@etudiant-enit.utm.tn'
    fromAdd = smtpUser
    subject ='test'
    header= 'to :' + toAdd + '\n' + 'from :' + fromAdd + '\n' + 'sub :' + subject
    body = 'temperature is higher than 30*C , air conditioning will be activated'
    print header + '\n' + body
